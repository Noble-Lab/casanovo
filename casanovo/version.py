...
def _get_version() -> Optional[str]:
    ...
    Using setuptools-scm dynamically sets the package version depending on the latest
    git release and commits since that point. This function returns the current version
    number.
