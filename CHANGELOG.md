...
- The amino acid scores and ProForma columns in the output mzTab files have been renamed to `opt_ms_global_aa_scores` and `opt_ms_global_cv_MS:1003169_proforma_peptidoform_sequence`, according to the mzTab specification.
