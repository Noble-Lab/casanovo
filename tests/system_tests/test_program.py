...
def test_denovo_casanovo(mgf_small):
    ...
    abs_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), '../../casanovo/config.yaml')
    ...
    mgf_files = [mgf_small/f for f in os.listdir(mgf_small) if (mgf_small/f).suffix.lower() == ".mgf"]
    ...
    if(isfile(os.path.join(os.path.dirname(os.path.abspath(__file__)), 'casanovo_output.csv'))):
        os.remove(os.path.join(os.path.dirname(os.path.abspath(__file__)), 'casanovo_output.csv'))
        assert True