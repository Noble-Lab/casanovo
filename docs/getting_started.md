...
To fine-tune an existing model with new post-translational modifications, additional configuration is required; see the [FAQ](faq#how-do-i-fine-tune-casanovo-on-data-with-new-ptms) for a detailed guide.
